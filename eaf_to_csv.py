...
def printoutput(output, wordmap, timestamp, current_language):  # print to the csv file
    output.write(wordmap[timestamp])
...
def main(argv):
    ...
    current_language = None  # to remember which language was encountered last
    thrown_away = 0
    numtimestamps = 0
    numwords = 0
    numlangchanges = 0
    ...
    for timestamp in timestamps:
        ...
        if timestamp in wordmap:  # there is a word at this time point
            ...
            if timestamp in syntaxmap and syntaxmap[timestamp] in languagemap:  # we have a clause change at this point
                ...
                printoutput(output, wordmap, timestamp, current_language)
