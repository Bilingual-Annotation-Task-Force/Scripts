...
# pos_transitions.py
# Using Python 3.4.3
"""PURPOSE: Calculate transitions between pos-tags to describe code-switching behavior in pos-tagged corpora."""
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Compute transitions of POS tags and languages over all tokens")
